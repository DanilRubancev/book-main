...
SECRET_KEY = 'django-insecure-_9^^gc%bx0e_5vmu!mxmk0@ife@45ac@3#ty!rn4u%7k%%5+p8'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'echo' / 'templates'], # Можно добавить глобальные папки с шаблонами
